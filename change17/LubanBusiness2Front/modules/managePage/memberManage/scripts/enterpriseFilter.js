function enterpriseFilterController() {
    ...
    var addEnterprise=function () {
        var addConfirm=function (list) {
            ...
            var enterpriseNames=list[0].value.split("\n");
            var enterpriseNameIndex=0;
            for(var i=0;i<enterpriseNames.length;i++){
                if(isSomething(enterpriseNames[i].trim())) {
                    postAddEnterpriseParam.enterpriseNames[enterpriseNameIndex]=enterpriseNames[i].trim();
                    enterpriseNameIndex++;
                }
            }
