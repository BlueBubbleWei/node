            ...
            for(var item in self.contentList){
                ...
                switch (self.contentList[item].type){
                    ...
                    case 'tips':
                        ...
                        inputDiv.css({'height':'40px','float':'left','margin':((perH-40)/2).toString()+'px 10px'});
                        inputDiv.appendTo(itemDiv);
                        var data = self.contentList[item].data;
                    ...
                    case 'enterpriseInfo':
                        ...
                        var dataDiv6=$('<div style="'+textOver+commonStyle+'" title="'+isEmpty(isEmpty(data.province)+'-'+isEmpty(data.city)+'('+isEmpty(data.region))+'">'+isEmpty(data.province)+'-'+isEmpty(data.city)+'('+isEmpty(data.region)+')'+'</div>');
