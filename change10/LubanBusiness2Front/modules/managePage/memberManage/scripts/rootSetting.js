...
function RootSetController() {
    ...
    var addRole=function () {
        var addConfirm=function (list) {
            postAddLBRoleParam.roleName=list[0].value;
    ...
    var updateRole = function (roleId, roleName,hasPermissionList,defaultRole) {
        var updateConfirm=function (list) {
            postUpdateLBRoleParam.roleName=list[0].value;
        ...
        var setHtml=function (itemFH,itemH) {
            ...
            for(var i=0;i<roleList.length;i++){
                ...
                tempHtml+='<div class="RoleSetListItems" style="height: '+itemH.toString()+'px;">' +
                    ...
                    '<div ng-click=\'updateRole("'+roleList[i].roleId+'","'+roleList[i].roleName+'","'+roleList[i].permissionGroupList+'","'+roleList[i].defaultRole+'")\' style="'+changeInfoStyle+'"></div>'
