...
//getAjax(ajaxParams.downFile.downDownUrl,null,ajaxParams.downFile.downSuccess,ajaxParams.downFile.downError,true);
    ...
    $scope.filterStatus = function(){
        ...
        isShowCancelBtn++;
        if(isShowCancelBtn %2==0){
            $('.ques-cancel').css({'display':'inline-block'})
        }else{
            $('.ques-cancel').css({'display':'none'})
        }
    };
    ...
    $("body").append('<div id="zoom" ><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="question-view"><div class="content loading" style="height:auto"></div></div><div class="page-num"></div></div>');
    var t = $("#zoom").hide(),
        n = $("#zoom .content"),
        r = false,
        i = null,
